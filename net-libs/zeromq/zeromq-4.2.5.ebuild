...
SRC_URI="https://github.com/FairRootGroup/libzmq/archive/v${PV}-fairroot.tar.gz -> libzmq-${PV}-fairroot.tar.gz"
S="${WORKDIR}/libzmq-${PV}-fairroot"
RESTRICT="mirror"

LICENSE="LGPL-3"
SLOT="0/5"
KEYWORDS="~amd64 ~arm ~arm64 ~hppa ~ia64 ~mips ~ppc ~ppc64 ~sparc ~x86 ~amd64-linux ~x86-linux ~x64-macos ~x86-macos"
IUSE="doc drafts pgm +sodium static-libs test unwind elibc_Darwin +fairroot"
