...
SRC_URI="
	https://cdn.kernel.org/pub/linux/kernel/v${KV_MAJOR}.x/linux-${KV_MAJOR}.${KV_MINOR}.tar.xz
	https://dev.gentoo.org/~mpagano/genpatches/tarballs/genpatches-${KV_MAJOR}.${KV_MINOR}-${K_GENPATCHES_VER}.base.tar.xz
