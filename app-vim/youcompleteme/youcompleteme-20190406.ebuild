...
inherit git-r3 eutils multilib python-single-r1 cmake-utils vim-plugin
SRC_URI=""
...
src_prepare() {
	...
	sed "s/\/usr\/lib\*\/llvm\/\*\/lib\*/\/usr\/lib\*\/llvm\/\*\/$(get_libdir)/g" -i third_party/ycmd/cpp/ycm/CMakeLists.txt
...
src_configure() {
	local mycmakeargs=(
		...
		-DUSE_PYTHON2=$(usex python_single_target_python2_7 ON OFF)
	)
